...
public class SLogin extends javax.swing.JFrame {
    ...
    private void btnsubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsubmitActionPerformed
        ...
        if((Uname.equals(uname1) && Pass.equals(p1)) || (Uname.equals(uname2) && Pass.equals(p2)))
        {
            ...
            this.dispose();
            OnlySeller.main(new String[]{Uname,Pass});

        }
        else{
            JOptionPane.showMessageDialog(SLogin.this, "Sorry, Username or Password Error","Login Error!", JOptionPane.ERROR_MESSAGE);
            txtusername.setText("");
            txtpassword.setText("");
        }
